-- Odstranjeni dve preverbi, ki NE MORETA sprozit.
--
-- Podvojen nastop na isti tekmi in dva kluba z enakim poenostavljenim imenom
-- prepreci ze enolicno kazalo v bazi (`appearances_match_id_player_id_key`,
-- `teams_drzava_poenostavljeno_ime_idx`). Preizkus z namerno okvaro tega ni
-- mogel niti vstaviti.
--
-- Preverba, ki se ne more sprozit, ni nedolzna: bralcu obljublja varovalko,
-- ki je ni, in daljsa seznam, ki ga je treba brati. Omejitev v bazi je boljsa
-- varovalka od poizvedbe — pade ob vpisu, ne sele ponoci.
--
-- Vsaka preostala preverba je preizkusena z namerno okvaro in se sprozi.
